...
# Create at least 4 tables, with the association table being one of them, that contain a
# many to many relationship and a many to one or one to many relationship. get back all
# the data you need with a single api call when querying the said relationships.
...
] = f"postgresql://{db_credentials}@localhost:5432/alchemy"
