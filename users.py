...
class Users(db.Model):
    ...
    # Connections:
    organization = db.relationship("Organizations", back_populates="users", lazy=True)
    user_transactions = db.relationship(
        "Transactions", back_populates="user", lazy=True
    )
...
class UsersSchema(ma.Schema):
    ...
    user_transactions = ma.fields.Nested("TransactionsSchema")
